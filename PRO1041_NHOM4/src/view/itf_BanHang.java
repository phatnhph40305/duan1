...
public class itf_BanHang extends javax.swing.JInternalFrame {
    ...
    private void thanhToan() {
        float tienthua = (float) (Double.valueOf(txtTienKhachDua.getText()) - Double.valueOf(txtTongtien.getText()));
        ...
        if (txtMaKhachHang.getText().equals("")) {
            hds.thanhtoantHoaDon1(idnd, idhoadon, tienthua);
            loadTableHoaDon0(hds.loadTableHoaDon0());
            fillTableHoaDonCT(hds.loadDataHoaDonChiTiet(idhoadon));
            modelhdct.setRowCount(0);
            clear();
        } else {
            if (hds.thanhtoantHoaDon(idkh, idnd, idnd, tienthua) == true) {
                hds.thanhtoantHoaDon(idkh, idnd, idhoadon, tienthua);
                loadTableHoaDon0(hds.loadTableHoaDon0());
                fillTableHoaDonCT(hds.loadDataHoaDonChiTiet(idhoadon));
                clear();
                modelhdct.setRowCount(0);
